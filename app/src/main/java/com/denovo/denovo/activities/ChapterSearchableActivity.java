...
public class ChapterSearchableActivity extends AppCompatActivity {

    private static final String TAG = "ChapterSearchableActivity";
    ...
    private ChapterSearchResultAdapter mChapterSearchResultAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter_searchable);
        ...
        mChapterSearchResultAdapter = new ChapterSearchResultAdapter(this);
        mSearchResultListView.setAdapter(mChapterSearchResultAdapter);
        mSearchResultListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Chapter selectedChapter = searchResults.get(position);
                Intent result = new Intent();
                result.putExtra("chapter_key", selectedChapter.getKey());
                result.putExtra("chapter_name", selectedChapter.getName());
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText.length() == 0) {
                    mChapterSearchResultAdapter.clearList();
                    loadingProgressBar.setVisibility(View.GONE);
                    return true;
                ...
                if (mChapterSearchResultAdapter.isEmpty()) {
    ...
    private void doSearch(String query) {
        ...
        loadingProgressBar.setVisibility(View.GONE);
        mChapterSearchResultAdapter.updateList(searchResults, query.length(), resultLocations);
    }
